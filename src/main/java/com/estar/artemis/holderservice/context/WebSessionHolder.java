package com.estar.artemis.holderservice.context;
...
public abstract class WebSessionHolder {
    ...
    public static void register(WebSocketSession session) {
        ...
        var userId = SocketSessionUtils.getSessionAttribute(session, ParamConstants.PARAM_USER_ID, String.class);
        WebSessionHolder.userIdMap.put(userId, session);
        var gameId = SocketSessionUtils.getSessionAttribute(session, ParamConstants.PARAM_USER_ID, String.class);
